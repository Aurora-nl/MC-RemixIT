...
def get_args():
    ...
    parser.add_argument(
        ...
        nargs="+",
        choices=["teacherGibbonsound", "hainangibbon", "libri1to3mix", "chime", "reverb_libri1to3mix"],
    )
    parser.add_argument(
        "--val",
        type=str,
        ...
        nargs="*",
        choices=["teacherGibbonsound", "hainangibbon", "libri1to3mix", "chime", "libri1to3chime", "reverb_libri1to3mix"],
    )
    parser.add_argument(
        "--test",
        type=str,
